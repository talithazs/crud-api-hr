...
<section id="content">
    <main>
        ...
        <div class="card" style="margin:20px;">
            <div class="card-header py-3">Edit Employee</div>
            <div class="card-body">
                ...
                <form action="{{ url('employee/' .$employees->id) }}" method="post">
                    ...
                    <label class="mb-3">Number</label></br>
                    <input type="tel" name="number" id="number" value="{{$employees->number}}" class="form-control"></br>
                    <label class="mb-3">Department</label></br>
                    <!-- <input type="text" name="region" id="region" class="form-control"></br> -->
                    <input class="form-control" list="datalistOptions" value="{{$employees->department}}" name="department" id="deparment" placeholder="Select Department">
