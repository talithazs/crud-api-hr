...
<section id="content">
    <main>
        ...
        <div class="card" style="margin:40px;">
            <div class="card-header py-3">Create New Location</div>
            <div class="card-body">
                <form action="{{ url('location') }}" method="post">
                    {!! csrf_field() !!}
                    <label class="mb-3">Street Address</label></br>
                    <input type="text" name="street_address" id="street_address" class="form-control"></br>
                    <label class="mb-3">City</label></br>
                    <input type="text" name="city" id="city" class="form-control"></br>
                    <label class="mb-3">Country</label></br>
                    <input class="form-control" list="datalistOptions" name="country" id="country" placeholder="Select Country">
