...
<section id="content">
    <main>
        ...
        <div class="card" style="margin:40px;">
            <div class="card-header py-3">Create New Department</div>
            <div class="card-body">
                <form action="{{ url('department') }}" method="post">
                    ...
                    <input type="text" list="datalistJobs" name="job_id" id="job_id" class="form-control"  placeholder="Select Job"></br>
                    ...
                    <input class="form-control" list="datalistOptions" name="country_id" id="country_id" placeholder="Select Country"></br>
                    ...
                    <input class="form-control" list="datalistManagers" name="manager_id" id="manager_id" placeholder="Select Manager"></br>
